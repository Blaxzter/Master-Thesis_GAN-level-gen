...
def leve_visualisation():
    ...
    level_rep1 = level_visualizer.visualize_level_img(level, dot_version = True, ax = ax[1, 0])

    Constants.resolution = 0.07
    level_visualizer.create_img_of_level(level, use_grid = True, add_dots = False, ax = ax[0, 1])
    level_rep2 = level_visualizer.visualize_level_img(level, dot_version = True, ax = ax[1, 1])

    Constants.resolution = 0.12
    level_visualizer.create_img_of_level(level, use_grid = True, add_dots = False, ax = ax[0, 2])
    level_rep3 = level_visualizer.visualize_level_img(level, dot_version = True, ax = ax[1, 2])
