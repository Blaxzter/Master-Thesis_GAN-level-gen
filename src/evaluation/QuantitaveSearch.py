...
class QuantitativeSearch:
    ...
    def start(self):
        ...
        quantitative_search_output = self.config.get_grid_search_file(f"quantitative_search_output")
        ...
        for epoch in tqdm(range(self.repeat_epochs)):

            if epoch < self.done_epochs:
                continue
